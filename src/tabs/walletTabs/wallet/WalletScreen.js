...
const WalletScreen = ({navigation}) =>{
    ...
    return <View style={styles.background}>
        {showWithdraw&&<RequestWithdrawal close={()=>{setShowWithdraw(false);setShowProcessing(true)}}/>}
        {showProcessing&&<WithdrawalProcessing close={()=>{setShowProcessing(false)}}/>}
        <ScrollView>
        <View style={styles.header}>
         <View style={styles.firstHeader}>
            ...
            <Pressable onPress={()=>setShowWithdraw(true)} style={styles.withdrawalBtn}>
                    <Text style={styles.withdrawalTxt}>
            ...
            <View  style={styles.earningsHolder}>
             ...
             {earnings.map((earning, key)=><View key={key} style={styles.container}>
