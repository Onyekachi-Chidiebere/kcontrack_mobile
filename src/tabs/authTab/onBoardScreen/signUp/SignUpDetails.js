...
const SignUpDetails = ({navigation, params, param, route}) => {
    ...
    const handleUpdate =()=>{
        ...
        handleChange(key,route.params[key])
    }
    ...
    return <View style={styles.background}>
       ...
       <Pressable onPress={()=>navigation.pop()} style={styles.backBtn}>
        ...
        <View style={styles.input}>
            <Input handleChange={handleChange}  name='phone' value={userData.phone}   label='Phone Number' placeholder={'Phone Number'}/>
        </View>
        <View style={styles.input}>
            <Input handleChange={handleChange} name='zip_code' value={userData.zip_code}   label='Zip Code' placeholder={'Zip Code'}/>
        </View>
        <View style={styles.input}>
            <Input secureTextEntry={true} handleChange={handleChange} name='password' value={userData.password}   handleChange={handleChange}  label='Password' placeholder={'Password'}/>     
        </View>
        <Pressable onPress={()=>{
            signup();
